...
/**
 * SwitchYardSubsystemGetApplications
 * 
 * Operation returning the applications deployed on the SwitchYard subsystem.
 * 
 * @author Rob Cernich
 */
public final class SwitchYardSubsystemGetApplications implements OperationStepHandler {

    public static final SwitchYardSubsystemGetApplications INSTANCE = new SwitchYardSubsystemGetApplications();

    private SwitchYardSubsystemGetApplications() {
