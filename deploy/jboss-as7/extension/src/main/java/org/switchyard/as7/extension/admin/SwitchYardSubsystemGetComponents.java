...
/**
 * SwitchYardSubsystemGetComponents
 * 
 * Operation returning the components registered with the SwitchYard subsystem.
 * 
 * @author Rob Cernich
 */
public final class SwitchYardSubsystemGetComponents implements OperationStepHandler {

    public static final SwitchYardSubsystemGetComponents INSTANCE = new SwitchYardSubsystemGetComponents();

    private SwitchYardSubsystemGetComponents() {
